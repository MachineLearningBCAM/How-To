...
\begin{document}
	...
	\section{Appendix 2: Use CVX in Matlab}
		...
		cvxsetup (with an underscore between the words cvx and setup. Just like you use that command in Matlab command window when you set up CVX in the beginning).\\
